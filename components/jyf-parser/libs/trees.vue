...
<script>
	...
	export default {
		...
		name: 'trees',
		inject: {
			registerTrees: { default: null },
			unregisterTrees: { default: null }
		},
		data() {
			return {
				ns: [],
		...
		mounted() {
			...
			// Vue 3: 自注册到父级 parser 的 treesRegistry（替代被移除的 $children 遍历）
			if (typeof this.registerTrees === 'function') this.registerTrees(this)
		},
		beforeUnmount() {
			if (typeof this.unregisterTrees === 'function') this.unregisterTrees(this)
		},
		methods: {
			// #ifndef MP-ALIPAY
			play(e) {
